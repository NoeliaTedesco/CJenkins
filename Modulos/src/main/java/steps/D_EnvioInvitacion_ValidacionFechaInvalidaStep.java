...
public class D_EnvioInvitacion_ValidacionFechaInvalidaStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "6_Se verifica el valor obtenido de la fecha al ingresar un dia/mes inválido";
			Assert.assertEquals(CurrentPage.As(D_Envio_InvitacionesPage.class).obtenerDatoFecha(),"2018-12-31");	
			log.Log.SuccessStep(nombrePaso);		
