...
public class D_EnvioInvitacion_VolverStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "6_Se selecciona volver ";
			Assert.assertTrue(CurrentPage.As(D_Envio_InvitacionesPage.class).clicBotonVolver());
			log.Log.SuccessStep(nombrePaso);

			nombrePaso = "7_Se verifica que se vuelve al Home";
			CurrentPage = (new D_HomePage().GetInstance(D_HomePage.class));
