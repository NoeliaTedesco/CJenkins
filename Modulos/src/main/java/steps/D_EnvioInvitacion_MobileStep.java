...
public class D_EnvioInvitacion_MobileStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "08_Se actualiza la grilla de invitaciones en despacho";
			...
			nombrePaso = "09_Se verifica que la invitacion no se muestre en la grilla de invitaciones";
			Assert.assertTrue(CurrentPage.As(D_Envio_InvitacionesPage.class).socioEnSalaEspera(inv.getNroSocio()));
			log.Log.SuccessStep(nombrePaso);
