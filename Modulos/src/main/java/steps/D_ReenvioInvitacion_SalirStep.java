...
public class D_ReenvioInvitacion_SalirStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "5_Se hace clic en el boton salir";
			Assert.assertTrue(CurrentPage.As(D_Envio_InvitacionesPage.class).esVisibleBtnReenvioSalir());
			CurrentPage.As(D_Envio_InvitacionesPage.class).clicBotonReenvioSalir();
			log.Log.SuccessStep(nombrePaso);
