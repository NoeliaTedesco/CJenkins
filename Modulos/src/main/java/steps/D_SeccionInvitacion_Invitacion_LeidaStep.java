...
public class D_SeccionInvitacion_Invitacion_LeidaStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			Assert.assertNull(
					CurrentPage.As(D_Envio_InvitacionesPage.class).recuperarFechaLecturaInvitacion(inv.getNroSocio()));
			log.Log.SuccessStep(nombrePaso);
			...
			nombrePaso = "10_Se verifica que se muestre la pagina para aceptar terminos y condiciones";
			...
			Assert.assertNotNull(
					CurrentPage.As(D_Envio_InvitacionesPage.class).recuperarFechaActualizacionGrillaInvitaciones());

			log.Log.SuccessStep(nombrePaso);

			nombrePaso = "12_Se verifica que la invitacion muestre fecha de lectura";
			Assert.assertNotNull(
					CurrentPage.As(D_Envio_InvitacionesPage.class).recuperarFechaLecturaInvitacion(inv.getNroSocio()));
			log.Log.SuccessStep(nombrePaso);
