...
public class D_SeccionInvitacion_Anular_CerrarPopUpStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "6_Se cierra el popUp seleccionado la cruz";
			CurrentPage.As(D_Envio_InvitacionesPage.class).clicBotonAnularCerrar();
			log.Log.SuccessStep(nombrePaso);
