...
public class D_SeccionInvitacion_Anular_SinMotivo_SalirStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "5_Se carga vacio el campo motivo en el popUp de anular";
			CurrentPage.As(D_Envio_InvitacionesPage.class).cargarMotivoAnular(inv.getMotivoAnular());
			log.Log.SuccessStep(nombrePaso);
			
			nombrePaso = "6_Se hace clic en el boton salir del popUp";
			CurrentPage.As(D_Envio_InvitacionesPage.class).clicBotonAnularSalir();	
			log.Log.SuccessStep(nombrePaso);

			nombrePaso = "7_Se verifica que la invitacion se siga mostrando en la grilla de invitaciones";
