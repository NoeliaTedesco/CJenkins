...
public class D_SeccionInvitacion_InvitacionRojaStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "4_Se verifica que la invitacion se encuentre colorada de rojo";
			Assert.assertTrue(CurrentPage.As(D_Envio_InvitacionesPage.class).invitacion15MinutosEnGrilla(inv.getNroSocio()));	
			log.Log.SuccessStep(nombrePaso);
