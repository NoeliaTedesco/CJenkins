...
public class D_SeccionInvitacion_Exportar_ValidacionFechasStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "8_Se valida que no hay invitaciones para ese periodo";
			Assert.assertEquals(CurrentPage.As(D_Envio_InvitacionesPage.class).recuperarMensajeToast(), "No hay invitaciones para el periodo dado.");
			log.Log.SuccessStep(nombrePaso);
