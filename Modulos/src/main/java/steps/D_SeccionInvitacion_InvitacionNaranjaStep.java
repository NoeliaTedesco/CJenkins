...
public class D_SeccionInvitacion_InvitacionNaranjaStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "3_Se verifica que se muestre la invitacion en la grilla";
			...
			nombrePaso = "4_Se verifica que la invitacion se encuentre colorada de naranja";
			Assert.assertTrue(CurrentPage.As(D_Envio_InvitacionesPage.class).invitacion10MinutosEnGrilla(inv.getNroSocio()));	
			log.Log.SuccessStep(nombrePaso);
