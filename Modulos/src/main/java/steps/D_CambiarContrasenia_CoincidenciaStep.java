...
public class D_CambiarContrasenia_CoincidenciaStep extends BaseStep {
	...
	public static void Run(String testName) {
		...
		try {
			...
			nombrePaso = "2_Se verifica visualización del botón para cambiar contraseña";
			...
			nombrePaso = "4_Se verifica correctamente la coincidencia de las contraseñas";
			...
			CurrentPage.As(D_CambiarContraseniaPage.class).ingresarReingresarContrasenia(pass.getContraseniaCoincidencia());
			CurrentPage.As(D_CambiarContraseniaPage.class).clickCampoNuevaContrasenia();
			
			Assert.assertEquals(CurrentPage.As(D_CambiarContraseniaPage.class).obtenerErrorLabelReingresarContrasenia(), "Confirmación del campo debe coincidir");
			log.Log.SuccessStep(nombrePaso);
			StepHelper.takeScreenShot(testName);
